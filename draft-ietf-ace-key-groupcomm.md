...
The payload of the 2.01 response is a CBOR map, which MUST include a dedicated nonce N_S generated by the KDC. The Client may use this nonce for proving the possession of its own private key (see the 'client_cred_verify' parameter in {{key-distr}}).
